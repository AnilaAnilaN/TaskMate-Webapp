// ============================================
// 5. Updated UserSearchModal.tsx (completed)
              ...
              {users.map((user) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-yellow-400 hover:bg-yellow-500 text-gray-900 rounded-xl font-medium transition-all flex items-center gap-2 hover:scale-105"
                  >
