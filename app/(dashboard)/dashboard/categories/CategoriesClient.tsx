              ...
              >
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 btn-secondary transition-colors"
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 px-3 py-2 rounded-xl text-sm font-medium flex items-center justify-center gap-2 transition-colors ${cannotDelete
